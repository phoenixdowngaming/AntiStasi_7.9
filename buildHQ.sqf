if((petros distance caja) > 30 || (petros distance cajaVeh) > 30) exitWith {hint "Move the ammoboxes closer to Petros.";};
if((!isNull (attachedTo caja)) || !(isNull (attachedTo cajaVeh))) exitWith {hint "You need to unload both ammoboxes first.";};

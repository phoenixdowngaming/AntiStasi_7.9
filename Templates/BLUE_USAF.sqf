...
bluAirCav = 	["rhsusf_usmc_fr_marpat_wd_teamleader","rhsusf_usmc_fr_marpat_wd_marksman","rhsusf_usmc_fr_marpat_wd_autorifleman","rhsusf_usmc_fr_marpat_wd_riflemanat","rhsusf_usmc_fr_marpat_wd_rifleman","rhsusf_usmc_fr_marpat_wd_autorifleman_m249"];

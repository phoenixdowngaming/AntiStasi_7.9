...
while {true} do {
	...
	//[ws_territory, 2] call ws_fnc_plotGrid;
	...
	private _newRoadblocks = [ws_frontline, ws_frontlineSmooth, ws_frontlineDir, controles, 800, false] call ws_fnc_putRoadblockmarkersAtFrontline;
